...
export class SeederService {
  ...
  async seedSkills() {
    const skills = [
      ...
      { name: 'Cooking', category: 'Lifestyle', description: 'Culinary arts and food preparation' },
      { name: 'Photography', category: 'Arts', description: 'Art and practice of creating images' },
      { name: 'Guitar', category: 'Music', description: 'String instrument playing' },
      { name: 'Spanish', category: 'Language', description: 'Spanish language learning' },
      { name: 'Yoga', category: 'Fitness', description: 'Physical and mental exercise practice' },
      { name: 'Drawing', category: 'Arts', description: 'Visual art form using various drawing instruments' },
    ];
  ...
  async seedAdminUser() {
    ...
    if (!existingAdmin) {
      await this.userModel.create({
        email: adminEmail,
        password: '$2a$10$rQZ8K9mN2pL1vX3yU7wE4t.5sA6bC8dF0gH1iJ2kL3mN4oP5qR6sT7uV8wX9yZ0',
        firstName: 'Admin',
        lastName: 'User',
        role: 'admin',
